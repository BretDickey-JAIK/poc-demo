...
module.exports = makeInjectable({
  ...
  try {
    // The movie _id, character _id and new character name all arrive as
    // route parameters rather than in the request body.
    ...
    // Locate the character subdocument by its _id. An invalid ObjectId
    ...
    if (typeof characterName !== "string" || characterName.trim().length < 3) {
